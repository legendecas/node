...
const Network = {
  ...
  webSocketFrameError: (params) => broadcastToFrontend('Network.webSocketFrameError', params),
  ...
  webSocketWillSendHandshakeRequest: (params) => broadcastToFrontend('Network.webSocketWillSendHandshakeRequest', params),
};
