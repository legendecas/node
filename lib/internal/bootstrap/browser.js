...
const taskQueues = require('internal/process/task_queues');
defineOperation(globalThis, 'queueMicrotask', taskQueues.queueMicrotask);
...
// Non-standard extensions: https://w3c.github.io/setImmediate/#si-setImmediate
