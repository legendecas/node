...
// internalBinding.
const internalBindingAllowlist = new Set([
  'async_wrap',
  'buffer',
  'cares_wrap',
  'config',
...
let internalBinding;
{
  ...
  internalBinding = function internalBinding(module) {
    ...
    if (typeof mod !== 'object') {
      ...
      Array.prototype.push.call(moduleLoadList, `Internal Binding ${module}`);
    }
    return mod;
  };
}
...
class NativeModule {
  ...
  */
  static map = new Map(
    moduleIds.map(id => [id, new NativeModule(id)])
  );

  constructor(id) {
    this.filename = `${id}.js`;
    this.id = id;
    this.canBeRequiredByUsers = !String.prototype.startsWith.call(id, 'internal/');
  ...
  compileForPublicLoader() {
    ...
    if (!this.exportKeys) {
      ...
      const internal = String.prototype.startsWith.call(this.id, 'internal/');
  ...
  getESMFacade() {
    ...
    const exportsKeys = Array.prototype.slice(this.exportKeys);
    Array.prototype.push(exportsKeys, 'default');
  ...
  compileForInternalLoader() {
    ...
    process._rawDebug(`load native module: ${id}`);
    // process._rawDebug(`typeof primordials.PromiseResolve: ${typeof primordials.PromiseResolve}`);
    process._rawDebug(`obj: ${typeof globalThis.obj.PromiseResolve}`);
    try {
      const requireFn = String.prototype.startsWith.call(this.id, 'internal/deps/') ?
    ...
    Array.prototype.push.call(moduleLoadList, `NativeModule ${id}`);
    return this.exports;
  }
}
