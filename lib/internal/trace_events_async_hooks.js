...
const { trace, nodeTraceEventCategory, usePerfetto } = require('internal/trace_events');
...
const kBeforeEvent = usePerfetto ? CHAR_UPPERCASE_B : CHAR_LOWERCASE_B;
const kEndEvent = usePerfetto ? CHAR_UPPERCASE_E : CHAR_LOWERCASE_E;
