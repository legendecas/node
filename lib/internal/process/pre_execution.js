...
function setupExperimentalVm() {
  ...
  if (getOptionValue('--experimental-vm-realm')) {
    const {
      Realm,
    } = require('internal/vm/realm');
    const vm = require('vm');
    vm.Realm = Realm;
  }
}
